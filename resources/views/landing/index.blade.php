...
<head>
    ...
    <meta name="description" content="persami membantu bisnis mengelola operasional dengan solusi digital yang sederhana, cepat, dan profesional.">
...
<body class="bg-[#f7f1e8] font-sans text-gray-900 antialiased">
    ...
    <header class="fixed inset-x-0 top-0 z-50 border-b border-gray-100 bg-white/95 backdrop-blur">
        ...
        <a href="{{ route('landing') }}" class="flex items-center gap-3">
            ...
            <div class="block text-lg font-bold leading-none text-[#4A2E1B]">BookStore</div>
        </a>
